class RealProperty:
    ...
    def price_difference(self, compared_to):
        main_property_price = self.square_metres * self.price_per_sqm
        second_property_price = compared_to.square_metres * compared_to.price_per_sqm
        return abs(main_property_price - second_property_price)

    def more_expensive(self, compared_to):
        main_property_price = self.square_metres * self.price_per_sqm
        second_property_price = compared_to.square_metres * compared_to.price_per_sqm
        return main_property_price > second_property_price
